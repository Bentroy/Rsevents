    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Lagos, Nigeria · Full-Service Event Management
          </span>
          <div
            style={{
              width: "36px",
        ...
        <div ref={titleRef} style={{ marginBottom: "1.5rem" }}>
          {["Crafting Events That", "Leave Lasting", "Impressions"].map(
            (line, i) => (
        ...
        >
          Recherché Events is a full-service event management company delivering
          exceptional experiences — from intimate celebrations to grand
          corporate gatherings across Lagos and beyond.
        </p>
        ...
        >
          <a
            ...
            onMouseEnter={(e) => {
              e.target.style.background = "var(--green-light)";
            }}
            onMouseLeave={(e) => {
